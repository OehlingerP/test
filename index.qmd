...
**Message:** `r current_training_status$secondary_status_message`

**What's the problem:** `r current_training_status$secondary_condition_messages`

**Which activities are blocked:** `r current_training_status$secondary_blocks`
...
ggplot(df_status, aes(x = date, y = as.numeric(priority))) + 
  geom_line() +
